    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            <div class="mb-6">
                ...
                <p class="text-gray-600 mt-2">Atualizar informações da empresa: {{ $company->nome }}</p>
            </div>

            <div class="bg-white rounded-lg shadow-md p-8">
                <form method="POST" action="{{ route('super_admin.companies.update', $company) }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="nome" id="nome" required
                                       ...
                                       value="{{ old('nome', $company->nome) }}" placeholder="Digite o nome da empresa">
                                @error('nome')
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" required
                                       ...
                                       value="{{ old('email', $company->email) }}" placeholder="contato@empresa.com">
                                @error('email')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <label for="logo" class="cursor-pointer inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        {{ $company->logo_path ? 'Alterar Logo' : 'Escolher Arquivo' }}
                                    </label>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="endereco" id="endereco" rows="3" required
                                          ...
                                          placeholder="Digite o endereço completo da empresa">{{ old('endereco', $company->endereco) }}</textarea>
                                @error('endereco')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div class="bg-blue-50 rounded-lg p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm font-medium text-blue-900">Usuários</p>
                                        <p class="text-2xl font-bold text-blue-600">{{ $company->users()->count() }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-green-50 rounded-lg p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm font-medium text-green-900">Categorias</p>
                                        <p class="text-2xl font-bold text-green-600">{{ $company->categories()->count() }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="bg-purple-50 rounded-lg p-4">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <p class="text-sm font-medium text-purple-900">Arquivos</p>
                                        <p class="text-2xl font-bold text-purple-600">{{ $company->files()->count() }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        function previewLogo(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    if (currentLogo) {
                        currentLogo.parentElement.style.opacity = '0.5';
                    }
                }
