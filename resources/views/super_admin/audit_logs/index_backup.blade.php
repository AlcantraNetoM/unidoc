            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold">{{ number_format($stats['total_logs']) }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold">{{ number_format($stats['today_logs']) }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-red-500 to-red-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold">{{ number_format($stats['critical_logs']) }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold">{{ number_format($stats['failed_logins']) }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold">{{ number_format($stats['unique_users_today']) }}</p>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(actionsCtx, {
        type: 'doughnut',
        data: {
            labels: {!! json_encode(array_keys($actionsChart)) !!},
            datasets: [{
                data: {!! json_encode(array_values($actionsChart)) !!},
                backgroundColor: [
    ...
    new Chart(dailyCtx, {
        type: 'line',
        data: {
            labels: {!! json_encode(array_keys($dailyActivity)) !!},
            datasets: [{
                label: 'Atividade Diária',
                data: {!! json_encode(array_values($dailyActivity)) !!},
                borderColor: '#3B82F6',
