...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Gerencie empresas, usuários e configurações do sistema</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-900">Total de Empresas</h3>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-900">Usuários sem Empresa</h3>
                        <p class="text-3xl font-bold text-yellow-600">{{ $stats['usuarios_sem_empresa'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h3 class="text-lg font-semibold text-gray-900">Total de Categorias</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 ml-3">Gerenciar Empresas</h2>
                </div>
                <p class="text-gray-600 mb-4">Criar, editar ou excluir empresas do sistema.</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 ml-3">Gerenciar Usuários</h2>
                </div>
                <p class="text-gray-600 mb-4">Gerenciar todos os usuários do sistema.</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 ml-3">Configurações</h2>
                </div>
                <p class="text-gray-600 mb-4">Configurar ajustes globais da aplicação.</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 ml-3">Categorias</h2>
                </div>
                <p class="text-gray-600 mb-4">Gerenciar categorias de todas as empresas.</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 ml-3">Relatórios</h2>
                </div>
                <p class="text-gray-600 mb-4">Visualizar relatórios e estatísticas do sistema.</p>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-200">
                <div class="flex items-center mb-4">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 ml-3">Logs de Auditoria</h2>
                </div>
                <p class="text-gray-600 mb-4">Revisar todas as ações realizadas no sistema.</p>
