...
<head>
    ...
    <title>UNIDOC - Registro Pessoal</title>
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="flex items-center justify-center py-20">
            <div class="max-w-md w-full mx-4">
                <div class="bg-white rounded-xl shadow-lg p-8 border hover:shadow-xl transition-shadow duration-300">
                    <!-- Header -->
                    <div class="text-center mb-8">                    <div class="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg class="w-10 h-10 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                        </svg>
                    </div>
                        <h1 class="text-3xl font-bold text-gray-900 mb-2">UNIDOC Pessoal</h1>
                        <p class="text-gray-600">Crie sua conta para organizar seus documentos com segurança</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register.store.pessoal') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="name" name="name" type="text" required 
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent transition duration-200 {{ (isset($errors) && $errors->has('name')) ? 'border-red-300' : '' }}" 
                        ...
                        <div>
                            ...
                            <input id="email" name="email" type="email" required 
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent transition duration-200 {{ (isset($errors) && $errors->has('email')) ? 'border-red-300' : '' }}" 
                        ...
                        <div>
                            ...
                            <input id="phone" name="phone" type="tel" 
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent transition duration-200 {{ (isset($errors) && $errors->has('phone')) ? 'border-red-300' : '' }}" 
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="password" name="password" type="password" required 
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent transition duration-200" 
                        ...
                        <div class="flex items-start">
                            ...
                            <label for="terms" class="ml-3 block text-sm text-gray-700">
                                Aceito os <a href="#" id="openTermsModal" class="text-green-600 hover:text-green-800 underline">termos e condições</a> *
                            </label>
                        </div>
        ...
        <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white">
            <div class="mt-3">
                ...
                <div class="flex items-center justify-end pt-4 border-t space-x-3">
                    ...
                    <button id="acceptTermsBtn" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition duration-200">
                        Aceitar Termos
                    </button>
                </div>
            </div>
