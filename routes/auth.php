...
Route::middleware('guest')->group(function () {
    ...
    Route::get('verify-reset-code', [PasswordResetCodeController::class, 'showVerifyForm'])
        ->name('password.verify.form');

    Route::post('verify-reset-code', [PasswordResetCodeController::class, 'verifyCode'])
        ->name('password.verify.code');

    Route::get('reset-password-form', [PasswordResetCodeController::class, 'showResetForm'])
        ->name('password.reset.form');

    Route::post('reset-password-save', [PasswordResetCodeController::class, 'resetPassword'])
        ->name('password.reset.save');

    // Rotas antigas do Laravel (manter para compatibilidade se necessário)
...
Route::middleware('auth')->group(function () {
    ...
    // Rota GET para logout que redireciona para login (para evitar erros de método)
