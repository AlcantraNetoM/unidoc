...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/vambertvan-dunem/Documents/Prova backup/prova/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Users/vambertvan-dunem/Documents/Prova backup/prova/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'empresa.create','empresa.store','empresa.logo',
'dashboard','files.index','files.create','files.store','files.show',
'files.edit','files.update','files.destroy','files.download','files.view',
'api.subcategories','categories.index','categories.create','categories.store','categories.show',
'categories.edit','categories.update','categories.destroy','subcategories.index','subcategories.create',
'subcategories.store','subcategories.show','subcategories.edit','subcategories.update','subcategories.destroy',
'users.index','users.create','users.store','users.show','users.edit',
'users.update','users.destroy','empresa.settings','empresa.reports','empresa.remove-logo',
'empresa.edit','empresa.update','empresa.show','profile.edit','profile.update',
'profile.destroy','super_admin.dashboard','super_admin.companies.index','super_admin.companies.create','super_admin.companies.store',
'super_admin.companies.edit','super_admin.companies.update','super_admin.companies.destroy','super_admin.users.index','super_admin.users.create',
'super_admin.users.assign.page','super_admin.users.assign','super_admin.users.store','super_admin.users.show','super_admin.users.edit',
'super_admin.users.update','super_admin.users.destroy','super_admin.users.approve','super_admin.users.reject','super_admin.categories.by_company',
'super_admin.settings','super_admin.settings.update','super_admin.categories.index','super_admin.categories.create','super_admin.categories.store',
'super_admin.categories.show','super_admin.categories.edit','super_admin.categories.update','super_admin.categories.destroy','super_admin.reports',
'super_admin.logs','register','account.pending','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout',);
        registerArgumentsSet('views', 
'auth.account-pending','auth.confirm-password','auth.forgot-password','auth.login','auth.register',
'auth.reset-password','auth.verify-email','categories.create','categories.edit','categories.index',
'categories.show','components.application-logo','components.auth-session-status','components.danger-button','components.dropdown',
...
'dashboard.admin','dashboard.awaiting-assignment','dashboard.error','dashboard.general-technician','dashboard.no-category',
'dashboard.normal-technician','empresa.register','empresa.reports','empresa.settings','empresa.users',
'files.create','files.edit','files.index','files.show','files.viewer',
'layouts.app','layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','super_admin.categories.create','super_admin.categories.edit','super_admin.categories.index',
'super_admin.categories.show','super_admin.companies.create','super_admin.companies.edit','super_admin.companies.index','super_admin.dashboard',
'super_admin.dashboard_new','super_admin.logs','super_admin.reports','super_admin.settings','super_admin.users.assign',
'super_admin.users.create','super_admin.users.edit','super_admin.users.index','super_admin.users.show','test-form',
